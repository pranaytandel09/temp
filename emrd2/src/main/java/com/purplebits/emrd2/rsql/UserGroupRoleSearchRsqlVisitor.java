...
public class UserGroupRoleSearchRsqlVisitor<T> implements RSQLVisitor<Specification<T>, Void> {

	private UserGroupRoleSearchRsqlSpecBuilder<T> builder;

	public UserGroupRoleSearchRsqlVisitor() {
		builder = new UserGroupRoleSearchRsqlSpecBuilder<>();
	}
