...
public class UserSearchRsqlSpecification<T> implements Specification<T> {
	...
	public UserSearchRsqlSpecification(final String property, final ComparisonOperator operator,
