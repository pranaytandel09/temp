...
public class UserGroupRoleSearchRsqlSpecification<T> implements Specification<T> {
	...
	public UserGroupRoleSearchRsqlSpecification(final String property, final ComparisonOperator operator,
