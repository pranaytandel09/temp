...
public class RecordsSearchRsqlSpecification<T> implements Specification<T> {
	 ...
	 */
	 private static final long serialVersionUID = 1L;
	    ...
	    public RecordsSearchRsqlSpecification(final String property, final ComparisonOperator operator,
