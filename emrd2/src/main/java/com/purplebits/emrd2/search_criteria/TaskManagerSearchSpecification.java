...
public class TaskManagerSearchSpecification implements Specification<TaskManagerView> {
	...
	*/
	...
	public TaskManagerSearchSpecification(final AuditTrailSearchCriteria criteria) {
		super();
	...
	@Override
	public Predicate toPredicate(Root<TaskManagerView> root, CriteriaQuery<?> query, CriteriaBuilder builder) {
