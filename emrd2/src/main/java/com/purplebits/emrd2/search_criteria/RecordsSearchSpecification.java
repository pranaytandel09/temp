...
public class RecordsSearchSpecification implements Specification<RecordsView> {
	...
	*/
	...
	public RecordsSearchSpecification(final AuditTrailSearchCriteria criteria) {
		super();
	...
	@Override
	public Predicate toPredicate(Root<RecordsView> root, CriteriaQuery<?> query, CriteriaBuilder builder) {
